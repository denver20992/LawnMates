...
const JobPostForm = ({ onSuccess }: JobPostFormProps): React.ReactNode => {
            ...
            <form onSubmit={(e) => {
                      ...
                      <div>
                        ...
                        <div className="mt-2 ml-4">
                          ...
                          <div className="mt-3 text-sm text-muted-foreground bg-muted p-3 rounded">
                            ...
                            <p>Your payment will only be processed when the job is completed and verified. No charges until then.</p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-3 pt-4 border-t">
                ...
                {step < 3 ? (
                  ...
                  >
                    {isSubmitting ? "Posting..." : "Post Job & Setup Payment"}
                  </Button>
                )}
              </div>
            </form>
